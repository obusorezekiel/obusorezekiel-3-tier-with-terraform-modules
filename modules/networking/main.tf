...
# Create Public Route table and associate it to Internet Gateway
resource "aws_route_table" "three_tier_public_route" {
  vpc_id = "aws_vpc.three_tier_vpc.id"
...
resource "aws_route" "default_public_route" {
  route_table_id = aws_route_table.three_tier_public_route.id
